                            ...
                            picker = new DatePickerDialog(CreateNewLead.this,
                                    new DatePickerDialog.OnDateSetListener() {
                                        ...
                                        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                            ...
                                            updateImportntDates.child(date).child("lead").child(messageKeyID).setValue(messageKeyID);
                                            updateLead.child(messageKeyID).updateChildren(hashMap);
                                        }
                                    }, year, month, day);
                            picker.show();

////                            AlertDialog.Builder builder = new AlertDialog.Builder(CreateNewLead.this);
////                            final EditText text = new EditText(CreateNewLead.this);
////                            text.setInputType(InputType.TYPE_CLASS_DATETIME);
////                            text.setPadding(20, 20, 20, 20);
//
//                            builder.setTitle("Enter Schedule Date").setMessage("eg: 12-06-2020\n*Use upper given format only");
...
////                                            Toasty.error(getApplicationContext(), "Enter Date in Correct Format").show();
////                                            return;
////                                        } else {
////
////                                            updateLead.child(messageKeyID).updateChildren(hashMap);
