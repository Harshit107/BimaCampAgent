...
public class PendingReferral extends Fragment {
    View progress;
    TextView ptext;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        nosuccess=view.findViewById(R.id.noPending);


        mauth = FirebaseAuth.getInstance();

        successAdapter = new ReferralRecyclerAdapter(messagelist,getApplicationContext());
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerPending);
        ...
        groupnameref = FirebaseDatabase.getInstance().getReference()
                .child("users").child("customer").child("registered").child("referral").child("pending");
        ...
        groupnameref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!dataSnapshot.hasChild(mauth.getUid())) {
                    ...
                    Toasty.info(getApplicationContext(),"No Pending Referral Found",Toasty.LENGTH_LONG,true).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_pending_referral, container, false);
    }
}
